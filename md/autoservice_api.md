...
Этот файл относится к старой ветке документации “AutoService” и содержит автосервисные поля (`car_brand`, “лист-наряд” и т.п.).

**Актуальная документация для Barber SaaS (салон красоты):**
- `md/README.md` — индекс документации
- `tasks.md` — единый TODO и текущие проблемы
- `md/00_PROJECT_OVERVIEW.md` и этапы `md/01..13_*.md`
