# 💇 Barber SaaS - Мульти-тенантная платформа для управления салонами красоты

Полнофункциональная мульти-тенантная SaaS платформа для управления салонами красоты с Telegram-ботами и веб-админ панелью.
...
### 💼 Мульти-тенантность
- Каждый клиент (салон красоты) получает изолированную базу данных
...
- Управление маркетингом (рабочие места, акции, промокоды)
...
# Юкасса (для платежей) - для localhost можно оставить пустыми
...
3. **Запустите проект (быстрый способ):**
```bash
...
- Супер-админ: http://localhost:3000/super-admin/login
...
1. Перейдите на страницу регистрации: `https://barber-saas.com/register`
